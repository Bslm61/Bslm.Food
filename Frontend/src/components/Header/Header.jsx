...
export const Header = () => {
  return (
    <div className="h-[50vh] sm:h-[45vh] md:h-[40vw] lg:h-[34vw] mx-auto my-6 md:my-8 lg:my-[30px] bg-[url('/header_img.png')] bg-cover bg-center flex flex-col justify-center items-start text-white p-4 sm:p-6 md:p-8 lg:p-10">
      <div className="mt-8 sm:mt-16 md:mt-32 lg:mt-40 animate-fade-in-scale">
        ...
        <p className="text-sm sm:text-base md:text-lg max-w-full sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] mb-6 md:mb-8">
