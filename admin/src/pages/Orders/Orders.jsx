...
export const Orders = ({url}) => {
  ...
  return (
    <div className="  py-8 px-4 sm:px-6  lg:px-8 max-w-4xl lg:max-w-7xl lg:w-5xl ">
      <h2 className="text-2xl sm:text-3xl font-bold text-[#49557e] mb-6 sm:mb-8">All Orders</h2>
      ...
      {loading ? (
        ...
        <div className="space-y-3 sm:space-y-4 ">
          {orders.map((order, index) => (
            <div key={index} className="border  border-gray-300 rounded-lg p-3 sm:p-4 lg:p-6 bg-white hover:shadow-md transition-shadow">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 sm:gap-4 items-start mb-4">
                ...
                <div className="text-right sm:text-left">
                  <p className="text-base sm:text-lg font-bold text-gray-800">${order.amount}</p>
