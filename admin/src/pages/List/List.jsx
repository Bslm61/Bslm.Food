    ...
    <div className="w-full max-w-6xl mx-auto p-4 md:p-8 flex flex-col gap-4">
      ...
      <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="hidden md:grid grid-cols-6 gap-4 bg-gray-50 p-4 border-b border-gray-200">
          ...
          <b className="text-sm text-gray-700 col-span-2 text-center">Actions</b> {/* ✅ Changed to Actions */}
        </div>

        {list.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-500">No food items found. Add some items to get started!</p>
          </div>
        ) : (
          list.map((item, index) => {
            return (
